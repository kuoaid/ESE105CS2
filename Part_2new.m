...
t2 = 129;
t = t2 - t1 + 1;
cases = table2array(COVID_STLmetro(t1:t2,"cases"))/2737140;
deaths = table2array(COVID_STLmetro(t1:t2,"deaths"))/2737140;
coviddata = [cases deaths];
...
plot(t1:t2,model_D);
legend('cases','deaths','model I','model D');
...
legend('cases','deaths','model I','model D','model I new','model D new');
